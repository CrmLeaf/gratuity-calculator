/*
 * Progressive enhancement for Gratuity Calculator.
 *
...
(function () {
    ...
    var TOOL = 'gratuity-calculator';
    var CALCULATOR = 'gratuity';
    var FIELDS = [
        { name: 'last_drawn_salary', argument: 'lastDrawnSalary', type: 'money' },
        { name: 'years_of_service', argument: 'yearsOfService', type: 'int' },
        { name: 'months_of_service', argument: 'monthsOfService', type: 'int' },
        { name: 'covered', argument: 'covered', type: 'bool' },
        { name: 'separation_reason', argument: 'separationReason', type: 'enum' },
