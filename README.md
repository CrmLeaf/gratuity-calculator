...
> [!TIP]
> **Nothing to install to try it.** [Gratuity Calculator on INDPayroll](https://www.indpayroll.com/free-tools/gratuity-calculator?utm_source=github&utm_medium=referral&utm_campaign=payroll-tools)
...
> ```json
> "repositories": [
>     { "type": "vcs", "url": "https://github.com/crmleaf/gratuity-calculator.git" },
