...
In scope: this package, `crmleaf/gratuity-calculator`.
...
[advisories]: https://github.com/crmleaf/gratuity-calculator/security/advisories/new
[calc]: https://github.com/crmleaf/gratuity-calculator/issues/new?template=calculation-error.yml
